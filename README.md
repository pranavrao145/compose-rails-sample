...
A sample development setup with Docker Compose and Rails, using a postgres database. The instructions below are for a **new** Rails project. If you want to use this template to dockerize an existing project, see Extra Notes below.
